...
def test_revoke_unvested_partially_unclaimed(deployed_vesting, token, owner, recipient, chain, start_time, end_time):
    ...
    assert token.balanceOf(owner) == deployed_vesting.total_locked() - expected_amount
