...
def test_deploy_voting_adapter(VotingAdapter, owner, voting, snapshot_delegate):
    voting_adapter = VotingAdapter.deploy(voting, snapshot_delegate, owner, {"from": owner})
